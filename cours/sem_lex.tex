...
Plutôt, nous utilisons un encodage moins couteau comme les relations avec les autres concepts ou encore un vecteur de nombres.
...
Du même, nous pouvons définir $L$ concepts comme des propriétés abstraites (nous ne savons pas c'est quoi ces propriétés). 
