...
\fi
%=====================================================================
\changegraphpath{../img/sens-phrases/}
\chapter{Sens de phrases}
...
Nous pouvons la représenter en \ac{fol} comme ``\expword{$\exists x\ DOG(x) \wedge LIKES(x, ALEX)$}".
...
Lorsque nous voulons générer l'exemple du début (\expword{Alex loves Brits}), nous devons appliquer ``NP.sem@VP.sem". 
...
Nous avons supposé que la réalisation sémantique du \keyword[S]{syntagme} verbal est $\lambda x.LIKES(x, BRITS)$. 
