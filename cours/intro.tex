...
Parmi les caractéristiques de cette ère, l'attention donnée à la conception des \keyword[C]{chatbot}s. 
...
Dans une grammaire des constituants, une phrase est constituée de plusieurs \keyword[S]{syntagme}s qui sont constitués des mots et d'autres \keyword[S]{syntagme}s.
