...
L'anglais est la langue la plus répondue ; mais, nous pouvons remarquer une augmentation du contenu des autres langues.
...
Donc, nous pouvons calculer la probabilité d'un segment (ensemble de mots consécutifs) par rapport un autre. 
...
Premièrement, une étape de clustering des phrases est exécutée afin extraire les sous-sujets du texte. 
...
Parmi les caractéristiques que nous puissions utiliser : nombre des entités nommées du type recherché, nombre des termes de la question, la séquence la plus longue similaire à la question, le rang du document, etc.
...
Lorsqu'il y a plusieurs domaines, nous devons appliquer la \keyword{détection d'intention} pour savoir quel cadre à utiliser. 
...
Aussi, nous devons détecter le stresse d'un mot en utilisant les suffixes et les préfixes. 
