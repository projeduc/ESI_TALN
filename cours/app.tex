...
Par exemple, en utilisant \keyword[B]{BERT}, on peut encoder la requête comme un vecteur $h_q$ et la réponse comme un vecteur $h_r$ (la sortie \keyword{[CLS]}) comme indiqué dans l'équation \ref{eq:chatbot-enc-bert}.
...
Parmi les problèmes, la présence de la négation ; cela peut être réglé en utilisant la structure de la phrase comme \keyword{RST}.
