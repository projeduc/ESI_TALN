...
En introduisant le sens de la deuxième phrase ``la fille a sentie une fleur", nous pouvons déduire que ``elle" est une référence à ``une fleur".
...
Personnellement, je ne sait pas s'il existe des langues où nous devons répéter les entités dans chaque phrase. 
