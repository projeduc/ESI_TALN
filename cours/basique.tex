...
Pour chercher des sous-chaines de caractères dans un texte, on peut utiliser les \keyword{expressions régulières} reconnaissant des langages de types 3 (langages réguliers) dans la hiérarchie de Chomsky. 
...
Une des techniques utilisées est \keyword{distance d'édition}.
...
\begin{itemize}
	...
	L'encodage le plus célèbre est \keyword{UTF-8}.
