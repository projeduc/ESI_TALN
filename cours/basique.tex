...
\begin{figure}[ht]
	...
	\begin{tabular}{|r|r|r|r|r|r|r|r|r|r|}
		...
		\hline
	\end{tabular}
	\caption[Exemple de calcul de distance de Levenshtein]{Exemple de calcul de distance de Levenshtein des mots ``amibe"  et ``immature"\label{fig:laven-distance}}
\end{figure}
%\begin{figure}[ht]
%	\centering
...
\begin{figure}[ht]
	...
	\begin{tabular}{|r|r|r|r|r|r|r|r|r|r|}
		...
		\hline
	\end{tabular}
	\caption[Exemple de calcul de distance de Damerau–Levenshtein]{Exemple de calcul de distance de Damerau–Levenshtein des mots ``amibe"  et ``immature"\label{fig:dam-laven-distance}}
\end{figure}
