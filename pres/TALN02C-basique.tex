...
\begin{itemize}
	...
	\item Catégorie grammaticale %: les catégories des mots avant le point peuvent aider la décision (limite ou non)
	\item Longueur du mot %: la longueur des mots avant et après le point
...
\begin{itemize}
	...
	\item le résultat : \keyword{lemme} (anglais : \keyword{lemma})
	\item exemple, \expword{comprennent \textrightarrow comprendre, better \textrightarrow good}
	\item doit avoir le contexte du mot. Ex. \expword{saw \textrightarrow (V) see ou (N) saw}
	\item \optword{basée sur des bases lexicales}
	\begin{itemize}
		\item \url{https://www.nltk.org/api/nltk.stem.html} (NLTK WordNetLemmatizer)
		\item \url{https://github.com/sloria/textblob}
		\item \url{https://spacy.io/}
	\end{itemize}
	\item \optword{basée sur l'apprentissage automatique}
	\begin{itemize}
		\item \url{https://opennlp.apache.org/}
	\end{itemize}
\end{itemize}
...
\hgraphpage{humour-lemmatisation.jpg}
