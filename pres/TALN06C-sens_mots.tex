...
\begin{block}{Les catégories lexicographiques des noms dans WordNet \cite{2019-jurafsky-martin}}
	...
	\begin{tabular}{@{\hskip0pt}l@{\hskip3pt}@{\hskip0pt}l@{\hskip3pt}@{\hskip0pt}l@{\hskip3pt}@{\hskip0pt}l@{\hskip3pt}@{\hskip0pt}l@{\hskip3pt}@{\hskip0pt}l@{\hskip3pt}}
		\hline\hline
...
\begin{block}{Quelques relations des noms et des verbes \cite{2019-jurafsky-martin}}
	\fontsize{8}{14}\selectfont
	\begin{tabular}{@{\hskip0pt}p{.2\textwidth}@{\hskip3pt}p{.48\textwidth}@{\hskip3pt}p{.25\textwidth}@{\hskip0pt}}
		\hline\hline
...
%		\hgraphpage{exp-glove_.pdf}
		...
		\begin{tabular}{@{\hskip0pt}l@{\hskip3pt}@{\hskip0pt}l@{\hskip3pt}@{\hskip0pt}l@{\hskip3pt}@{\hskip0pt}l@{\hskip3pt}@{\hskip0pt}l@{\hskip3pt}}
			\hline\hline
