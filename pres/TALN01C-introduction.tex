...
\begin{center}
	\vgraphpage{humour-phonetics.jpg}
\end{center}
...
\begin{center}
	\vgraphpage{humour-semantics.jpg}
\end{center}
...
\begin{itemize}
	...
	\item Réponse : du \keyword{contexte}
\end{itemize}
\end{minipage}
...
\begin{itemize}
	...
	\item le modèle du discours le plus utilisé est \keyword{Rhetorical Structure Theory (RST)}
...
\begin{center}
	\vgraphpage{humour-pragmatics.jpg}
\end{center}
...
\begin{itemize}
	...
	\item Résolution d'ellipse : trouver les éléments omis du texte. Exemple d'ellipse : \expword{``Pierre mange des cerises, Paul des fraises"}
\end{itemize}
...
\begin{itemize}
	...
	\item Analyse de sentiment : par exemple, \expword{vérification si des utilisateurs sont satisfaits par un produit ou non}
	\item Recommandation automatique de documents : par exemple, \expword{recommander des livres}
\end{itemize}
...
\begin{itemize}
	\item polysémie : un mot ayant plusieurs sens. Ex. \expword{Indien : de l'Inde, indigène des Amériques}
	\item énantiosémie : un terme polysémique ayant deux sens antonymes. Ex. \expword{Regret, désigne la plainte ou la nostalgie : ``Je regrette mon enfance".}
	\item Trope (langage figuratif) : métaphores (\expword{``It's raining cats and dogs"}), métonomie (\expword{``La salle a applaudi" [les gens dans la salle]}), ironie (``Quelle belle journée !" [pour signifier qu'il pleut des cordes.])
...
\begin{itemize}
	...
	\item Variations et communication non standard. \expword{langue de chat, arabizi, franglais, etc.}
	\item Intention 
	\item Émotions 
\end{itemize}
