...
\begin{itemize}
	\item \keyword{polysémie} : un mot ayant plusieurs sens. Ex. \expword{Indien : de l'Inde, indigène des Amériques}
	\item \keyword{énantiosémie} : un terme polysémique ayant deux sens antonymes. Ex. \expword{Regret, désigne la plainte ou la nostalgie : ``Je regrette mon enfance".}
