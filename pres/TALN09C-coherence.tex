...
\begin{frame}
	...
	\begin{itemize}
		\item Un discours est cohérent s'il existe des relations entre ces parties
		\item La structure
		\begin{itemize}
			\item Un arbre de relations : RST
			\item Une relation binaire entre deux parties : PDTB
		\end{itemize}
	\end{itemize}
