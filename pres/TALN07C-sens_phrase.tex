...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Exemple : \expword{$ \lambda $x.UTILISER(x, BERT)} pour représenter l'expression \expword{utilise BERT}
		\end{itemize}
		...
		\begin{itemize}
			...
			\item Exemple : \expword{$ \lambda $x.UTILISER(x, BERT)\ KARIM = UTILISER(KARIM, BERT)}
		\end{itemize}
	\end{itemize}
...
\begin{center}
	...
	\begin{tabular}{llll}
		...
		\hgraphpage[0.7\textwidth]{sem-arbre.pdf}
\end{center}
...
\begin{frame}
	...
	\begin{center}
		\vgraphpage{humour/humour-sens.jpg}
	\end{center}
