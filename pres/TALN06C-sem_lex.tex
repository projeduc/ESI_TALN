...
\begin{itemize}
	...
	\item Elle sont difficiles à gérer 
	...
	\item Ici, on se focalise sur le Word embedding basé sur les réseaux de neurones
...
\begin{itemize}
	...
	\begin{itemize}
		\item Teste la similarité (\expword{coast, shore}) et pas l'association (\expword{clothes, closet})
	\end{itemize}
